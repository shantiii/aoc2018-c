...
size_t parse_de_boy(struct node *node, int input[], size_t offset) {
...
void traverse(struct node *n, void *ctx, traverse_fn fun) {
  fun(n, ctx);
...
void sum_meta(struct node *x, int *acc) {
  int tmp;
